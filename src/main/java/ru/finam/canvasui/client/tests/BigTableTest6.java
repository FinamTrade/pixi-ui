...
import ru.finam.canvasui.client.js.gsap.easing.Quart;
import ru.finam.canvasui.client.js.gsap.easing.Sine;
 ...
 */
public class BigTableTest6 extends PixiScrollerTest {

    public static final String NAME = "Big table scrolling Sine ease";
    ...
    private static ScrollPanel fixedSizeScrollPanel1(CustomComponentContainer innerPanel) {
        ...
        ScrollPanel scrollPanel =  ScrollPanel.newInstance(innerPanel, width, 500, false, Sine.Static.easeOut());
        return scrollPanel;
    }
